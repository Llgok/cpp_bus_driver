...
class Hi8561 final : public ChipMipiGuide {
 public:
  enum class CabcMode {
    kOff = 0x00,    // CABC关闭
    kUiMode,        // 用户界面模式
    kStillPicture,  // 静态图片模式
    kMovingPicture  // 动态图片模式
  };
  ...
  explicit Hi8561(std::shared_ptr<BusMipiGuide> bus,
 ...
 private:
  ...
  static constexpr uint8_t kInitSequence[] = {
      ...
      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xDE, 0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xBB, 7, 0x0F,
      0x10, 0x43, 0x50, 0x32, 0x44, 0x44,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xBF, 2, 0x46,
      0x32,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC0, 4, 0x01,
      0xAD, 0x01, 0xAD,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xBD, 2, 0x00,
      0xB4,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC6, 23,
      0x00, 0x7D, 0x00, 0xC8, 0x00, 0x17, 0x1A, 0x82, 0x00, 0x00, 0x00, 0x01,
      0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC8, 3, 0x23,
      0x48, 0x87,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xCC,
      0x31,  // 2lane

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xBC, 3, 0x2E,
      0x80, 0x84,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC3, 25,
      0x3B, 0x01, 0x02, 0x05, 0x0C, 0x0C, 0x75, 0x0A, 0x79, 0x0A, 0x79, 0x02,
      0x6E, 0x02, 0x6E, 0x02, 0x6E, 0x0A, 0x0D, 0x0A, 0x0F, 0x0A, 0x0F, 0x0A,
      0x0F,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC4, 24,
      0x01, 0x02, 0x05, 0x0C, 0x0C, 0x75, 0x0A, 0x79, 0x0A, 0x79, 0x02, 0x6E,
      0x02, 0x6E, 0x02, 0x6E, 0x0A, 0x0D, 0x0A, 0x0F, 0x0A, 0x0F, 0x0A, 0x0F,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC5, 23,
      0x03, 0x05, 0x0C, 0x0C, 0x75, 0x0A, 0x79, 0x0A, 0x79, 0x02, 0x6E, 0x02,
      0x6E, 0x02, 0x6E, 0x0A, 0x0D, 0x0A, 0x0F, 0x0A, 0x0F, 0x0A, 0x0F,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xD7, 17,
      0x00, 0x0A, 0x63, 0x0A, 0x63, 0x0A, 0x63, 0x0A, 0x63, 0x0A, 0x63, 0x0A,
      0x63, 0x0A, 0x63, 0x0A, 0x63,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xCB, 43,
      ...
      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xCE, 23,
      0x00, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,
      0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xCF, 45,
      ...
      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xD0, 29,
      ...
      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xD5, 61,
      ...
      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xCD, 2, 0x00,
      0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xDE, 0x01,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xB9, 4, 0x00,
      0xFF, 0xFF, 0x04,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC7, 3, 0x1F,
      0x14, 0x0E,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xDE, 0x02,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xE5, 24,
      0x00, 0x60, 0x60, 0x02, 0x18, 0x60, 0x18, 0x60, 0x09, 0x04, 0x00, 0xC5,
      0x01, 0x2C, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x04,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xE6, 3, 0x10,
      0x10, 0x82, static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData),
      0xC4, 7, 0x00, 0x11, 0x07, 0x00, 0x11, 0x01, 0x08,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC3, 2, 0x20,
      0xFF,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xBD, 0x1B,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC6, 2, 0x4A,
      0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xCD, 4, 0x14,
      0x64, 0x11, 0x40,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC1, 10,
      0x00, 0x40, 0x00, 0x02, 0x02, 0x02, 0x02, 0x7F, 0x00, 0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xB3, 2, 0x00,
      0xA8,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xBB, 11,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x41, 0x40, 0x43, 0x04,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xC2, 10,
      0x02, 0x42, 0x50, 0x00, 0x02, 0xE4, 0x61, 0x73, 0xF9, 0x08,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xEC, 14,
      0x07, 0x07, 0x40, 0x00, 0x22, 0x02, 0x00, 0xFF, 0x08, 0x7C, 0x00, 0x00,
      0x00, 0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xDE, 0x03,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8ByteData), 0xD1, 5, 0x00,
      0x00, 0x21, 0xFF, 0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8D8), 0xDE, 0x00,

      static_cast<uint8_t>(InitSequenceFormat::kWriteC8), 0x35,
      static_cast<uint8_t>(InitSequenceFormat::kDelayMs), 30,
