        ...
        static constexpr uint32_t _init_list[] =
            {
                ...
                static_cast<uint8_t>(Init_List_Format::WRITE_C8_R24_D8), static_cast<uint8_t>(Cmd::WO_WRITE_REGISTER), 0x00FE00, 0x00, // page switch
                static_cast<uint8_t>(Init_List_Format::WRITE_C8_R24_D8), static_cast<uint8_t>(Cmd::WO_WRITE_REGISTER), 0x00C400, 0x80, // spi mode
                ...
                static_cast<uint8_t>(Init_List_Format::WRITE_C8_R24_D8), static_cast<uint8_t>(Cmd::WO_WRITE_REGISTER), 0x005300, 0x20, // write control display1
