...
namespace Cpp_Bus_Driver
{
    ...
    public:
        ...
        bool read(const uint32_t write_c32, uint8_t *read_data, size_t read_data_length = 1);
        ...
        bool write(const uint32_t write_c32, const uint8_t *write_data, size_t write_data_length);
